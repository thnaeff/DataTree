 ...
 *
 */
public abstract class GenericOnOffKeyListTreeNode<K, V, N extends GenericOnOffKeyListTreeNode<K, V, N>>
extends GenericKeyListTreeNode<K, V, N> implements OnOffTreeNodeInterface<N> {
   ...
   * @param value
   */
  public GenericOnOffKeyListTreeNode(K key, V value) {
    super(key, value);
