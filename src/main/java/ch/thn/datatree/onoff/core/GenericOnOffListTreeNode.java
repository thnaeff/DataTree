...
import ch.thn.datatree.core.GenericListTreeNode;
 ...
 *
 */
public abstract class GenericOnOffListTreeNode<V, N extends GenericOnOffListTreeNode<V, N>>
extends GenericListTreeNode<V, N> implements OnOffTreeNodeInterface<N> {
   ...
   * @param value
   */
  public GenericOnOffListTreeNode(V value) {
    super(value);
