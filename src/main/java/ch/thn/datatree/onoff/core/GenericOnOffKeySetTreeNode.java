 ...
 *
 */
public abstract class GenericOnOffKeySetTreeNode<K, V, N extends GenericOnOffKeySetTreeNode<K, V, N>>
extends GenericKeySetTreeNode<K, V, N> implements OnOffTreeNodeInterface<N> {
   ...
   * @param value
   */
  public GenericOnOffKeySetTreeNode(Comparator<? super K> keyComparator,
   ...
   * @param value
   */
  public GenericOnOffKeySetTreeNode(K key, V value) {
    super(key, value);
    base = new OnOffTreeNodeBase<N>(internalGetThis());
  }
