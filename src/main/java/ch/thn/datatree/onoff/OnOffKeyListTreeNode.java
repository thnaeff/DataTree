 ...
 *
 */
package ch.thn.datatree.onoff;

import ch.thn.datatree.onoff.core.GenericOnOffKeyListTreeNode;
 ...
 *
 */
public class OnOffKeyListTreeNode<K, V> extends GenericOnOffKeyListTreeNode<K, V, OnOffKeyListTreeNode<K, V>> {
  ...
  public OnOffKeyListTreeNode<K, V> nodeFactory(V value) {
    return new OnOffKeyListTreeNode<K, V>(null, value);
  }

  @Override
  public OnOffKeyListTreeNode<K, V> nodeFactory(OnOffKeyListTreeNode<K, V> node) {
    return new OnOffKeyListTreeNode<K, V>(node.getNodeKey(), node.getNodeValue());
  }

  @Override
  public OnOffKeyListTreeNode<K, V> nodeFactory(K key, V value) {
    return new OnOffKeyListTreeNode<K, V>(key, value);
  }
