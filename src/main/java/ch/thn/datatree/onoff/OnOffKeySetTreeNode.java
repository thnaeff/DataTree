 ...
 *
 */
public class OnOffKeySetTreeNode<K, V> extends GenericOnOffKeySetTreeNode<K, V, OnOffKeySetTreeNode<K, V>> {
  ...
  public OnOffKeySetTreeNode<K, V> nodeFactory(V value) {
    return new OnOffKeySetTreeNode<K, V>(null, value);
  }

  @Override
  public OnOffKeySetTreeNode<K, V> nodeFactory(OnOffKeySetTreeNode<K, V> node) {
    return new OnOffKeySetTreeNode<K, V>(node.getKeyComparator(), node.getValueComparator(), node.getNodeKey(), node.getNodeValue());
  }

  @Override
  public OnOffKeySetTreeNode<K, V> nodeFactory(K key, V value) {
    return new OnOffKeySetTreeNode<K, V>(key, value);
  }
