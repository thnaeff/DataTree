 ...
 * @param <I>
 */
public abstract class GenericTreeIterator<N extends CollectionTreeNodeInterface<?, N>, I extends Iterator<N>>
implements Iterator<N> {
	 ...
	 */
	public GenericTreeIterator(N toIterate) {
	 ...
	 * {@link GenericTreeIterator} class.
	 * 
	 * @param node
	 * @return
	 */
